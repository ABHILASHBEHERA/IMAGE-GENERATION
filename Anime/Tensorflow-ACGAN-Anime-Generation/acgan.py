...
class ACGAN(object):
    ...
    def build_model(self):
        ...
        print('------------ACGGAN build_model() train with real-------------')
        #train with real
        ...
        print('-------------ACGGAN build_model() train with fake-------------')
        #train with fake
        d_f_tag = self.rand_seq
        fake = self.g_net(d_f_tag, self.z)
        print('-------------------1st g_net call over------------------')
